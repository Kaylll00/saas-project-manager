...
function SkeletonKanbanColumn({ className }: { className?: string }) {
  return (
    <div className={cn("rounded-xl border border-slate-200 bg-slate-50 shadow-sm", className)}>
      <div className="flex items-center justify-between rounded-t-xl border-t-4 border-slate-400 bg-white px-4 py-3">
...
function SkeletonActivityItem({ className }: { className?: string }) {
  return (
    <div className={cn("flex items-start space-x-3 pb-3 border-b border-slate-100", className)}>
